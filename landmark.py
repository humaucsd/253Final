...
def get_landmark_model(weight_dir):
    ...
    #Make our own layers
    fc_fiducial1 = Dense(512, activation='relu', name='fc_fiducial1')(alex_out)
    fc_fiducial2 = Dense(42, activation='softmax', init='he_normal', name='fc_fiducial2')(fc_fiducial1)

    fc_visibility1 = Dense(512, activation='relu', name='fc_visibility1')(alex_out)
    fc_visibility2 = Dense(21, activation='softmax', init='he_normal', name='fc_visibility2')(fc_visibility1)

    # merged_output = layers.merge([fc_fiducial2, fc_visibility2],mode='concat')
