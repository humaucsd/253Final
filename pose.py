...
def get_pose_model(weight_dir):
    ...
    #Make our own layers
    fc_pose1 = Dense(512, activation='relu', name='fc_pose1')(alex_out)
    fc_pose2 = Dense(3, activation='softmax', init='he_normal', name='fc_pose2')(fc_pose1)

    #Defining the model
    pose_model = Model(input = alex_model.input, output=fc_pose2)
    return pose_model
